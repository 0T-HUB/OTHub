<script>
  ...
  const deleteAlertByIndex = (alertIndexToBeDeleted) => $badge.LiveOutages = $badge.LiveOutages.filter((alertText, alertIndex) => alertIndex !== alertIndexToBeDeleted)
</script>

{#if $badge && $badge.LiveOutages}
